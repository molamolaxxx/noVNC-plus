...
export default class RFB extends EventTargetMixin {
    ...
    set showOriginCursor(show) {
        this._showOriginCursor = show;
        if (show) {
            this._preCursor = this._canvas.style.cursor
            this._canvas.style.cursor = "auto"
        } else {
            this._canvas.style.cursor = this._preCursor;
        }
    }
